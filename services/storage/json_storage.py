...
class JSONStorageBackend(StorageBackend):
    """Backend lưu trữ file JSON cục bộ"""
    ...
    def load_auth_keys(self) -> list[dict[str, Any]]:
        """Tải dữ liệu khóa xác thực từ file JSON"""
    ...
    def save_auth_keys(self, auth_keys: list[dict[str, Any]]) -> None:
        """Lưu dữ liệu khóa xác thực vào file JSON"""
        self.auth_keys_path.parent.mkdir(parents=True, exist_ok=True)
    ...
    def get_backend_info(self) -> dict[str, Any]:
        """Lấy thông tin backend lưu trữ"""
        return {
            "type": "json",
            "description": "Lưu trữ file JSON cục bộ",
            "file_path": str(self.file_path),
            "file_exists": self.file_path.exists(),
            "auth_keys_file_path": str(self.auth_keys_path),
            "auth_keys_file_exists": self.auth_keys_path.exists(),
