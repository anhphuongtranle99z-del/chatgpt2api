...
def create_storage_backend(data_dir: Path) -> StorageBackend:
    ...
    - STORAGE_BACKEND: json|sqlite|postgres|git (defaults to json)
    ...
    - GIT_BRANCH: Git branch (defaults to main)
    - GIT_FILE_PATH: file path inside the Git repository (defaults to accounts.json)
    """
