            ...
            <div className="space-y-2">
              ...
              <Select value={config.mode || "total"} onValueChange={(value) => setMode(value as "total" | "quota" | "available")} disabled={config.enabled}>
                ...
                <SelectContent>
                  ...
                  <SelectItem value="quota">Hạn mức còn lại trong kho tài khoản</SelectItem>
          ...
          <div className="space-y-3 border-t border-stone-200 pt-3">
            <div className="flex items-center justify-between gap-3">
              <div>
                ...
                <p className="mt-1 text-xs text-stone-500">Có thể cấu hình nhiều nhà cung cấp, luân phiên theo thứ tự bật.</p>
              </div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <div className="space-y-2">
                <label className="text-sm text-stone-700">Thời gian chờ mã xác minh</label>
              ...
              <div className="space-y-2">
                <label className="text-sm text-stone-700">Khoảng thăm dò</label>
        ...
        <div className="mt-4 flex min-h-0 flex-1 flex-col space-y-3 overflow-hidden border-t border-stone-200 pt-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="mt-1 text-xs text-amber-700">Nếu gặp lỗi như mã HTTP 400, thường là email bị chặn do lạm dụng; cần đổi sang email tên miền mới.</p>
              </div>
