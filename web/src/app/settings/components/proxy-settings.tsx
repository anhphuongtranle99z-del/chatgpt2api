          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">
                Cấu hình proxy đi ra cho các yêu cầu tới chatgpt.com, phù hợp với máy chủ cần proxy để truy cập ra ngoài; các yêu cầu Sub2API / CPA không bị ảnh hưởng.
              </p>
            </div>
          </div>
        </div>
            ...
            <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-stone-200 bg-white px-4 py-3">
              ...
              <div className="space-y-0.5">
                ...
                <div className="text-sm text-stone-500">
                  Khi tắt, yêu cầu tới chatgpt.com sẽ kết nối trực tiếp. Có hiệu lực ngay sau khi lưu, không cần khởi động lại.
                </div>
              </div>
            </label>
