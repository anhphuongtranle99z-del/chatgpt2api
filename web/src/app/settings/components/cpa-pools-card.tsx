      ...
      <CardContent className="space-y-6 p-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Cấu hình kết nối trước, rồi truy vấn tài khoản từ xa và chọn nhập vào pool cục bộ khi cần.</p>
            </div>
          </div>
        ...
        {isLoadingPools ? (
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-xl bg-stone-50 px-6 py-10 text-center">
            ...
            <div className="space-y-1">
              ...
              <p className="text-sm text-stone-400">Nhấn "Thêm kết nối" để lưu thông tin CLIProxyAPI.</p>
            </div>
          </div>
        ) : (
        ...
        <div className="rounded-xl bg-stone-50 px-4 py-3 text-sm leading-6 text-stone-500">
          ...
          <ul className="mt-1 list-inside list-disc space-y-0.5">
            <li>Trang sẽ tải các kết nối CPA đã cấu hình trong hệ thống.</li>
            <li>Nhấn "Đồng bộ" trên một kết nối để tải danh sách tài khoản từ xa và hiển thị để chọn.</li>
            <li>Sau khi xác nhận, backend tải access_token tương ứng ở nền và nhập vào pool cục bộ.</li>
            <li>Giao diện chỉ polling tiến độ nhập, không trực tiếp tải xuống.</li>
          </ul>
        </div>
      </CardContent>
    </Card>
