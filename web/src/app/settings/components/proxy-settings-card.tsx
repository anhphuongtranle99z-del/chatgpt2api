        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-stone-500">Cấu hình proxy thống nhất cho các yêu cầu đi ra của hệ thống; có hiệu lực ngay sau khi lưu.</p>
            </div>
          </div>
          ...
          <>
            <div className="space-y-2">
              ...
              <p className="text-sm text-stone-500">
                Để trống nghĩa là không dùng proxy. Vui lòng nhập địa chỉ đầy đủ, ví dụ `http://127.0.0.1:7890`, `http://username:password@127.0.0.1:7890` hoặc `socks5://127.0.0.1:7890`.
              </p>
            </div>
