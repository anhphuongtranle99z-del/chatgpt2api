        ...
        <CardContent className="space-y-6 p-6">
          <div className="flex items-start justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-stone-500">Tạo khóa riêng cho người dùng thường; người dùng thường chỉ vào được trang tạo ảnh, không xem được cài đặt và pool tài khoản.</p>
              </div>
            </div>
          ...
          {isLoading ? (
            ...
            <div className="rounded-xl bg-stone-50 px-6 py-10 text-center text-sm text-stone-500">
              Chưa có khóa người dùng thường. Bấm nút góc trên bên phải để tạo và phân phát cho người khác.
            </div>
          ) : (
        ...
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Có thể nhập tên ghi chú để phân biệt người dùng; sau khi tạo sẽ sinh một khóa gốc chỉ xem được một lần.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="Ví dụ: Đồng nghiệp thiết kế A, tài khoản tạm cho vận hành"
      ...
      <Dialog open={Boolean(deletingItem)} onOpenChange={(open) => (!open ? setDeletingItem(null) : null)}>
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Xác nhận xóa khóa người dùng "{deletingItem?.name}"? Sau khi xóa, khóa này sẽ không thể tiếp tục gọi API.
            </DialogDescription>
          </DialogHeader>
          <DialogFooter>
            <Button
      ...
      >
        <DialogContent className="rounded-2xl p-6">
          <DialogHeader className="gap-2">
            ...
            <DialogDescription className="text-sm leading-6">
              Có thể sửa tên ghi chú; nếu cần đổi khóa riêng, nhập trực tiếp khóa gốc mới. Để trống để giữ khóa hiện tại.
            </DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs leading-5 text-stone-500">
                Sau khi lưu, khóa cũ hết hiệu lực ngay và khóa mới có hiệu lực. Hệ thống vẫn chỉ lưu hash, không hiển thị lại khóa hiện tại.
              </p>
            </div>
          </div>
          <DialogFooter>
