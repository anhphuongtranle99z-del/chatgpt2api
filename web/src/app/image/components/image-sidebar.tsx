      ...
      <div className="flex h-full min-h-0 flex-col gap-2 py-1 sm:gap-3 sm:py-2">
        ...
        >
          {isLoadingHistory ? (
            ...
            <div className="px-2 py-3 text-sm leading-6 text-stone-500">Chưa có lịch sử ảnh. Nhập lời nhắc, kết quả sẽ hiển thị ở đây.</div>
          ) : (
                  ...
                  >
                    ...
                    {stats.running > 0 || stats.queued > 0 ? (
                      <div className="mt-2 flex flex-wrap items-center gap-2 text-[11px]">
                        ...
                        {stats.queued > 0 ? (
                          <span className="rounded-full bg-amber-50 px-2 py-1 text-amber-700">Đang xếp hàng {stats.queued}</span>
                        ) : null}
                      </div>
                    ) : null}
                  </button>
